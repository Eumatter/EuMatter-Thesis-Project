                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center gap-1.5 sm:gap-2" style={{ minHeight: 'fit-content' }}>
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-6 lg:space-x-8 flex-shrink-0 min-w-0">
                        ...
                        <div className="relative" ref={bellRef} style={{ contain: 'layout style paint' }}>
							...
							{/* Notifications Dropdown - Works on both mobile and desktop */}
							{isBellOpen && (
                                <div className="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-80 md:w-96 max-w-[calc(100vw-2rem)] sm:max-w-none bg-white rounded-2xl shadow-2xl border border-gray-200/80 z-[110] overflow-hidden backdrop-blur-sm"
									style={{
                        ...
                        <div className="relative" ref={dropdownRef} style={{ contain: 'layout style paint' }}>
                            ...
                            {isDropdownOpen && (
                                <div className="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-72 lg:w-80 bg-white rounded-2xl shadow-2xl border border-gray-200/80 overflow-hidden z-[120] backdrop-blur-sm"
									style={{
										animation: 'fadeIn 0.2s ease-out, slide-down 0.2s ease-out',
										boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
										maxHeight: 'calc(100vh - 10rem)',
