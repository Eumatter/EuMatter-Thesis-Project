    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Page Header - same style as Reports, Notifications, CRD pages */}
                <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 mb-6 sm:mb-8 border border-gray-200">
                    <div>
                        <h1 className="text-3xl sm:text-4xl font-bold mb-2" style={{ backgroundImage: 'linear-gradient(to right, #800000, #900000)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Community Events</h1>
                        <p className="text-gray-600 text-base sm:text-lg">Discover and join events that make a difference in your community.</p>
                    </div>
                </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        ...
                                        {event.description && (
                                            <p className="text-gray-600 text-sm mb-4 line-clamp-3 max-w-none">
